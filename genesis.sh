...
curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{"$class": "pt.ua.attr.RA", "name": "e.g. a bank regulator", "type": "BANK", "memberID": "0001", "certificate": ""}' http://localhost:3000/api/RA
printf "\n"

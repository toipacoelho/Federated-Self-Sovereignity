...
curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{"$class": "pt.ua.attr.User", "memberID": "0005", "certificate": ""}' http://localhost:3000/api/User
printf "\n\n"

...
export class AttributeComponent implements OnInit {
  ...
  constructor(private serviceAttribute: AttributeService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceAttribute.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    ...
    return this.serviceAttribute.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceAttribute.updateAsset(form.get('attrID').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceAttribute.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceAttribute.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
